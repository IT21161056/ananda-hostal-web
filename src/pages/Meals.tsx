...
import { UtensilsCrossed, Package, ClipboardList } from "lucide-react";
...
import InventoryUsageRecorder from "../components/Meals/InventoryUsageRecorder";

export default function Meals() {
  const [activeTab, setActiveTab] = useState<
    "planning" | "inventory" | "usage"
  >("planning");
